...
const deserializeAws_querySendDataPoint = (output, context) => {
    ...
    if (output["DeliveryAttempts"] !== undefined) {
        contents.DeliveryAttempts = smithy_client_1.strictParseInt(output["DeliveryAttempts"]);
    }
    if (output["Bounces"] !== undefined) {
        contents.Bounces = smithy_client_1.strictParseInt(output["Bounces"]);
    }
    if (output["Complaints"] !== undefined) {
        contents.Complaints = smithy_client_1.strictParseInt(output["Complaints"]);
    }
    if (output["Rejects"] !== undefined) {
        contents.Rejects = smithy_client_1.strictParseInt(output["Rejects"]);
    }
    return contents;
};
