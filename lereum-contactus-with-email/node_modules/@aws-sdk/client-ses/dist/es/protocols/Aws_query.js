...
var deserializeAws_querySendDataPoint = function (output, context) {
    ...
    if (output["DeliveryAttempts"] !== undefined) {
        contents.DeliveryAttempts = __strictParseInt(output["DeliveryAttempts"]);
    }
    if (output["Bounces"] !== undefined) {
        contents.Bounces = __strictParseInt(output["Bounces"]);
    }
    if (output["Complaints"] !== undefined) {
        contents.Complaints = __strictParseInt(output["Complaints"]);
    }
    if (output["Rejects"] !== undefined) {
        contents.Rejects = __strictParseInt(output["Rejects"]);
    }
    return contents;
};
