...
export declare type TDerivedItemValue<T> = T extends boolean ? {
    BOOL: T;
} : T extends null ? INullItemValue : T extends number ? INumberItemValue : T extends string ? {
    S: T;
...
//# sourceMappingURL=derived-item-value.d.ts.map